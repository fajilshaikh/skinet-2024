...
export const routes: Routes = [
    ...
    { path: 'admin', loadComponent: () => import('./features/admin/admin.component').then(c => c.AdminComponent) , canActivate: [authGuard, adminGuard] }, // if you do not want create routes.ts as above checkout and order
