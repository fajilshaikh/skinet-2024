...
public class CacheAttribute(int timeToLiveSeconds) : Attribute, IAsyncActionFilter
{
    public async Task OnActionExecutionAsync(ActionExecutingContext context, ActionExecutionDelegate next)
    {
        ...
        var cachedResponse = await cacheSerivce.GetCachedResponseAsync(cacheKey);
        ...
        if(executedContext.Result is OkObjectResult okObjectResult)
        {
            ...
            {
                await cacheSerivce.CacheResponseAsync(cacheKey, okObjectResult.Value, TimeSpan.FromSeconds(timeToLiveSeconds));
            }
        }
    }
